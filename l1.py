        ...
        with open(self.file, "r", encoding="utf-8") as file:
            ...
            while index <= self.examCount:
                ...
                for i, line in enumerate(_lines):
                    ...
                    audios.append(self.getTtsData(text, "Xiaogang"))

                    text = f"<speak>{ds[0]}<break time='10s' /></speak>"
                    audios.append(self.getTtsData(text, "Aixia"))
...
def main():
    ...
    if file == '':
        file = 'D:\Projects\Python3\Lesson\L1\TLCS\英文单词.txt'
